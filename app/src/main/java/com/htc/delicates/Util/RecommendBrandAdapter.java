...
public class RecommendBrandAdapter extends RecyclerView.Adapter<RecommendBrandAdapter.MyViewHolder> implements View.OnClickListener{
    ...
    public RecommendBrandAdapter(Context context, List<Brand> brandList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.recommend_brand_item, viewGroup,false);
