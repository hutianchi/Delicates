...
import com.htc.delicates.Adapter.RecommedUpdateAdapter;
import com.htc.delicates.Adapter.RecommendAdapter;
...
public class RecommendFragment extends Fragment implements RecommedUpdateAdapter.onItemClick{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recommendAdapterBrand = new BrandAdapter(getActivity(), brandList, R.layout.recommend_brand_item);
