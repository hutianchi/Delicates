...
import com.htc.delicates.Util.ClothesAdapter;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class NormalSelectFragment extends Fragment implements View.OnClickListener{
    ...
    private String sizes[] = new String[]{"XXS","XS","S","M","L","XL","XXL","均码","XXXS","XXXL"};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_select_nomal, container, false);
        ...
        horizontalScrollView3 = (HorizontalScrollView) view.findViewById(R.id.horizontalScrollView3);
